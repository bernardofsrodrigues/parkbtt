...
import codigo.view.Faturamento;
...
public class FaturamentoController {
    ...
    public void recuperarEstatisticas(String mes) {
        switch (mes) {
            case "Todos": view.getTextAreaEstatisticas().setText(getArrecadacaoTotal()); 
                break;
    ...
    private String getArrecadacaoMes(int mes) {
        return "Total arrecadado no mês: " + estacionamentoAtual.arrecadacaoNoMes(mes);
    }
