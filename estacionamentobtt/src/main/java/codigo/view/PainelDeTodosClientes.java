...
public class PainelDeTodosClientes extends JFrame {
    ...
    public PainelDeTodosClientes(Estacionamento estacionamentoAtual) {
        setSize(600, 500);
        setLocationRelativeTo(null);
        setDefaultCloseOperation(EXIT_ON_CLOSE);

        this.controller = new ClienteController(this, estacionamentoAtual);
                        ...
                        btnVeiculos.addActionListener(new ActionListener() {
                            ...
                            public void actionPerformed(ActionEvent e) {
                                ...
                                if(controller.clienteTemVeiculos(cpfCliente)) {
                                    dispose();
                                    new Veiculos(estacionamentoAtual, cpfCliente).setVisible(true);
